...
RUN apt-get -y install git ssh python3-pip wget net-tools vim curl make build-essential lsb-release
...
COPY ./hsrb_wrs_gazebo_launch /catkin_ws/src/hsrb_wrs_gazebo_launch
COPY ./tmc_wrs_gazebo_worlds   /catkin_ws/src/tmc_wrs_gazebo_worlds
